...
<body class="nav-md">
            ...
            <!-- /top navigation -->
                                        ...
                                        // if the form's submit button is clicked, we need to process the form
                                            if (isset($_POST['submit'])) {
                                                ...
                                                $sql = "INSERT INTO `user_details`(`name`, `occupation`, `pnumber`, `product_status`, `date`, `time`) VALUES ('$name','$occupation','$pnumber','$product_status','$date','$time')";
                                                ...
                                                if ($result == TRUE) {
                                                    echo "<span class='container'>New record created successfully.</span>";
                                                }else{
  ...
  <fieldset>
    ...
    <br>
    pnumber:<br>
    <input type="pnumber" name="pnumber">
    <br>
    date:<br>
    ...
    <input type="submit" name="submit" value="submit">
                                ...
                                <div class="x_content">
                                   ...
                                   <form action="" method="POST">
                                        <fieldset>
                                            ...
                                            <br>
                                            Phone Number:<br>
                                            <input class="form-control" type="pnumber" name="pnumber">
                                            <br>
                                            <div>   Select Product Status :<br>
                                    ...
                                    <!-- <form class="" action="" method="POST" novalidate>
                                     ...
                                     <!--   <div class="field item form-group">
                                        ...
                                        <!-- <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="number" class='number' name="pnumber"  required='required'></div>
                                        </div>
                                        <div class="field item form-group">
            ...
            <footer>
                ...
                Developed by <a href="http://krminfotech.epizy.com">K.Mohamed Hasim</a>
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
